...
$check_rif = "SELECT * FROM proveedor WHERE rif_proveedor = '$rif' AND id_proveedor != '$id_proveedor'";
...
$sql_actualizar = "UPDATE proveedor SET 
    rif_proveedor = '$rif', 
    nombre = '$nombre', 
    direccion = '$direccion', 
    telefono = '$telefono', 
...
// Ejecutar consulta
if (mysqli_query($con, $sql_actualizar)) {
    $response = [
        'success' => true,
    ...
    $response = [
        'success' => false,
        'message' => 'No se pudo actualizar el proveedor: ' . mysqli_error($con)
    ];
